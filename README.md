Kibana was a little more straight forward of an installation. I'll jump in here after install where I generated the token that would be used for the elasticsearch API
